...
@section('title', trans('general.title.new', ['type' => trans('operations::general.receivable-types')]))

@section('content')
    <div class="card">
        <form method="POST" action="{{ route('operations.settings.receivable-types.store') }}" accept-charset="UTF-8" id="receivable-type"
              role="form" class="form-loading-button" novalidate enctype="multipart/form-data">
            @csrf
        <div class="card-body">
            <div class="row">
